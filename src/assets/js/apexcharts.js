...
var Graphics = function () {
  ...
  _createClass(Graphics, [{
    ...
    value: function drawLine(x1, y1, x2, y2) {
      var lineColor = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : 'rgba(255,255,255,0.08)';
    ...
    value: function drawPath(_ref) {
      var _ref$d = _ref.d,
          ...
          stroke = _ref$stroke === undefined ? 'rgba(255,255,255,0.08)' : _ref$stroke,
    ...
    value: function drawPattern(style, width, height) {
      var stroke = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 'rgba(255,255,255,0.08)';
    ...
    value: function getTextRects(text, fontSize, fontFamily, transform) {
      ...
      var virtualText = this.drawText({
        ...
        foreColor: 'rgba(255,255,255,0.08)',
        opacity: 0
      });
...
var Core = function () {
  ...
  _createClass(Core, [{
    ...
    value: function createGridMask() {
      ...
      w.globals.dom.elGridRect = graphics.drawRect(0, 0 - markerSize * 1.2, w.globals.gridWidth, w.globals.gridHeight + markerSize * 2.4, 0, 'rgba(255,255,255,0.08)');
